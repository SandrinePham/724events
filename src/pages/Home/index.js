      ...
      <main>
        ...
        <section className="ServicesContainer">
          ...
          <div className="ListContainer">
            <ServiceCard imageSrc={`${process.env.PUBLIC_URL}/images/priscilla-du-preez-Q7wGvnbuwj0-unsplash1.png`}>
            ...
            <ServiceCard imageSrc={`${process.env.PUBLIC_URL}/images/hall-expo.png`}>
              <h3>Conférences</h3>
            ...
            <ServiceCard imageSrc={`${process.env.PUBLIC_URL}/images/sophia-sideri-LFXMtUuAKK8-unsplash1.png`}>
        ...
        <section className="PeoplesContainer">
          ...
          <div className="ListContainer">
            <PeopleCard
              imageSrc={`${process.env.PUBLIC_URL}/images/stephanie-liverani-Zz5LQe-VSMY-unsplash.png`}
              name="Samira"
              position="CEO"
            />
            <PeopleCard
              imageSrc={`${process.env.PUBLIC_URL}/images/linkedin-sales-solutions-pAtA8xe_iVM-unsplash.png`}
              name="Jean-baptiste"
              position="Directeur marketing"
            />
            <PeopleCard
              imageSrc={`${process.env.PUBLIC_URL}/images/christina-wocintechchat-com-SJvDxw0azqw-unsplash.png`}
              name="Alice"
              position="CXO"
            />
            <PeopleCard
              imageSrc={`${process.env.PUBLIC_URL}/images/jonas-kakaroto-KIPqvvTOC1s-unsplash.png`}
              name="Luís"
              position="Animateur"
            />
            <PeopleCard
